...
if ( function_exists( 'wc_get_endpoint_url' ) ) {
	...
	add_filter( 'wcs_view_subscription_actions', 'PIE\WCSubscriptionFrontendActions\add_renew_sub_action', 10, 2 );
	...
	add_filter( 'wcs_view_subscription_actions', 'PIE\WCSubscriptionFrontendActions\redirect_resub_sction', 10, 2 );
}
